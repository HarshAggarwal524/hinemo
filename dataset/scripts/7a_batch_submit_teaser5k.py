"""
HinEmo — Batch API Labeling, Submit Job (hinglish_teaser_5k) — chunked
=============================================================================
5,000 rows at ~650 tokens/request (long prompt with 7 examples) totals
~3.25M tokens — exceeds the 2M enqueued-token ceiling as a single job.
Chunking into 2 pieces, same pattern as the SentiMix fix.
"""
...
BATCH_INPUT_TEMPLATE = "data/interim/teaser5k_batch_input_part{n}.jsonl"
